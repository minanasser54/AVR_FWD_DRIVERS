...
/* Function name        : MDIO_voidEnablePullUp
   Function description : Enable internal pullup on specific pin
   Function arguments   : u8 Copy_u8Port,u8 Copy_u8Pin
   Function returns     : void
*/
void MDIO_voidEnablePullUp(u8 Copy_u8Port,u8 Copy_u8Pin);

/* Function name        : MDIO_voidDisablePullUp
   Function description : Disable internal pullup on specific pin
   Function arguments   : u8 Copy_u8Port,u8 Copy_u8Pin
   Function returns     : void
*/
...
/* Function name        : MDIO_voidWriteLowNibble
   Function description : Write on first four bits on specific register
   Function arguments   : u8 Copy_u8Port,u8 Copy_u8Value
   Function returns     : void
*/
...
/* Function name        : MDIO_voidWriteHighNibble
   Function description : Write on last four bits on specific register
   Function arguments   : u8 Copy_u8Port,u8 Copy_u8Value
   Function returns     : void
*/
